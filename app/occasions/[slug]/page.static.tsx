/**
 * Static-export-only variant of the occasion landing page, swapped in for
 * app/occasions/[slug]/page.tsx by scripts/build-static.sh. Adds
 * generateStaticParams so the export knows every occasion route; the data
 * comes from the in-memory fixture via getOccasionProducts (STATIC_EXPORT).
 */
